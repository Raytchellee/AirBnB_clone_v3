...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="foo@mailinator.com", password="Pa$$word1")
        new_user.save()

        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "meh"))
        self.assertIs(None, models.storage.get("meh", "meh"))
    ...
    def test_count(self):
        ...
        new_state = State(name="Santiago")
        new_state.save()
        new_user = User(email="test1234@mailinator.com", password="Pa$$word1")
        new_user.save()
